...
export default function VitalsPendingScreen({ navigation }) {
  ...
  return (
    <SafeAreaView className="flex-1 bg-surface-app">
      ...
      <View className="flex-1 items-center justify-center px-8">
        ...
        <Text className="text-center text-xl font-bold text-ink">Vitals Not Recorded Yet</Text>
        <Text className="mt-2 text-center text-sm text-ink-soft">
          Please visit the front desk so a nurse can record your vitals and generate your UHID
          and token number. Appointment booking unlocks right after.
        </Text>
