...
export default function DoctorListScreen({ navigation, route }) {
  ...
  // Only part of an active booking flow (started from Symptom Check /
  // resuming an in-progress appointment) if an appointmentId was handed in;
  // otherwise this screen is reached purely for browsing and stays view-only.
