...
export default function NurseBookSlotScreen({ navigation, route }) {
  const { mrNo, appointmentId, doctor } = route.params;
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (appointment.status === 'confirmed') {
        ...
        navigation.navigate('NursePayment', { mrNo, appointmentId, amount: doctor.consultationFee });
      }
    } catch (err) {
